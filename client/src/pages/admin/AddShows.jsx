      ...
      <div className="overflow-x-auto pb-4">
        <div className="group flex flex-wrap gap-4 mt-4 w-max">
          {nowPlayingMovies.map((movie) => (
            <div
              key={movie.id}
              className={`relative max-w-39 cursor-pointer group-hover:not-hover:opacity-40 hover:-translate-y-1 transition duration-300`}
                    ...
                    <li key={date}>
                        ...
                        <div className='flex flex-wrap gap-2 mt-1 text-sm'>
                            {times.map((time) => (
                                ...
                                border-primary px-2 py-1 flex items-center rounded'>
                                    <span>{time}</span>
                                    <DeleteIcon onClick={()=>
